...
class _SummaryScreenState extends State<SummaryScreen> {
  List<String> sentences = [
    "gpt@인공지능(AI)은 데이터를 분석하고 패턴을 인식하여 문제를 해결하는 기술입니다.",
    "gpt@머신러닝은 AI의 한 분야로, 기계가 스스로 학습하는 능력을 갖추게 합니다.",
    "gpt@딥러닝은 인공신경망을 사용해 복잡한 데이터 분석을 수행하는 머신러닝의 하위 분야입니다.",
    "gpt@자율주행차는 AI 기술을 활용하여 교통 상황을 인식하고 스스로 주행합니다.",
    "gpt@AI 챗봇은 자연어 처리 기술로 사용자와 대화하며 다양한 정보를 제공합니다.",
    "gpt@AI 챗봇은 자연어 처리 기술로 사용자와 대화하며 다양한 정보를 제공합니다.",
  ];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Container(
        child:
            (taskModel.summaryTexts == null || taskModel.summaryTexts!.isEmpty)
                ? const Text('생성중')
                : Column(
                    children: [
                      Expanded(
